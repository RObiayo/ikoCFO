        ...
        <div className="max-w-6xl mx-auto space-y-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2  gap-5 lg:gap-12">
            ...
            <div className="p-8 bg-transparent shadow-lg rounded-lg border-t-4 border-blue-600">
              <h3 className=" text-xl md:text-2xl  lg:text-2xl font-bold text-gray-800 mb-4">Our Vision</h3>
              <p className="text-gray-600 text-xs md:text-lg lg:text-lg leading-relaxed">
            ...
            {/* Mission */}
            <div className="p-8 bg-transparent shadow-lg rounded-lg border-t-4 border-blue-600">
              <h3 className=" text-xl md:text-2xl lg:text-2xl font-bold text-gray-800 mb-4">Our Mission</h3>
              <p className="text-gray-600 text-xs md:text-lg lg:text-lg leading-relaxed">
